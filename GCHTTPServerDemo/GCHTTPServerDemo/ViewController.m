...
- (void)viewDidLoad {
    ...
    httpSocket.rootPath = @"/Users/xiaofeng/Documents/mygithub/GCHTTPServer/GCHTTPServer.git/trunk/GCHTTPServerDemo/GCHTTPServerDemo/WebResource";
...
- (void)loadWebView {
   ...
   __block NSURL *url = [NSURL URLWithString:@"http://127.0.0.1:8888/group/index.html"];
